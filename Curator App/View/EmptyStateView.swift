...
//  Watchout
//
//  Created by Marat Galeev on 19.11.2018.
...
@IBDesignable final class EmptyStateView: UIView {
    ...
    @IBInspectable var activityIndicatorColor: UIColor = Colors.darkActivityIndicator {
        didSet {
    ...
    @objc
    fileprivate func onActionButtonTouchUpInside(_ sender: UIButton) {
